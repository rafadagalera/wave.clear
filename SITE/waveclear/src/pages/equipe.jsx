    ...
    <>
      <div className=" py-24 sm:py-32 lg:py-48">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <h2 className="text-4xl lg:text-5xl font-bold text-primary-white text-center mb-8 sm:mb-12">Conheça a equipe</h2>
          <p className="text-lg lg:text-xl text-primary-white text-center leading-7 lg:leading-9 mb-12 sm:mb-16 lg:mb-20">A solução foi idealizada por dois alunos do primeiro ano de Engenharia de Software na Faculdade de Informática e Administração Paulista - FIAP.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2   gap-8 sm:gap-12 lg:gap-16 justify-center"> 
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="text-center">
                <h3 className="text-lg lg:text-xl font-semibold text-primary-white">Vinicius Taiki</h3>
                <p className="text-base lg:text-lg font-semibold text-primary-gray">RM - 554226</p>
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="text-center">
                <h3 className="text-lg lg:text-xl font-semibold text-primary-white">Rafael Nascimento</h3>
                <p className="text-base lg:text-lg font-semibold text-primary-gray">RM - 554226</p>
