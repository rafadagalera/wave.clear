function Equipe() {
  return (
    <>
      <div className=" md:py-24 sm:py-32 lg:py-48 w-full">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <h2 className="text-4xl lg:text-5xl font-bold text-teal-700 text-center mb-8 sm:mb-12">Conheça a equipe</h2>
