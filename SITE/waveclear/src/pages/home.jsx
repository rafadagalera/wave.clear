    ...
    return (
        <>
            <div className='flex flex-col gap-4 mt-5 md:w-3/4 md:m-auto'>
                <h1 className='text-4xl m-auto md:mt-20'>Nós somos wave.clear</h1>
            ...
            <div className="mt-8 flex flex-col gap-8 mb-5 md:flex-row md:w-3/4 md:m-auto md:mt-20">
                {cards.map((card) => (
                    <div key={card.id} className="group relative box-border border-2 border-primary-white rounded-xl p-5 ">
                        ...
                        <button className="flex m-auto mt-4 box-border border-2 border-primary-black bg-button-blue text-primary-white h-14 w-44 items-center justify-center rounded-md md:mt-20"><Link to={card.link}>Saiba mais</Link></button>
                    </div>
                ))}
            </div>
        </>
